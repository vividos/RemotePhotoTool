...
static PropIdDisplayInfo g_aPropIdDisplayInfo[] =
{
   ...
   // capture properties
   {
      kEdsPropID_AEMode,
      {
         ...
         { kEdsAEMode_CreativeFilter, _T("Creative filter") },
         { kEdsAEMode_RoughMonoChrome, _T("Rough monochrome") },
         { kEdsAEMode_SoftFocus, _T("Soft focus") },
         { kEdsAEMode_ToyCamera, _T("Toy camera") },
         { kEdsAEMode_Fisheye, _T("Fisheye") },
         { kEdsAEMode_WaterColor, _T("Waltercolor") },
         { kEdsAEMode_Miniature, _T("Miniature") },
         { kEdsAEMode_Hdr_Standard, _T("HDR Standard") },
         { kEdsAEMode_Hdr_Vivid, _T("HDR Vivid") },
         { kEdsAEMode_Hdr_Bold, _T("HDR Bold") },
         { kEdsAEMode_Hdr_Embossed, _T("HDR Embossed") },
         { kEdsAEMode_Movie_Fantasy, _T("Movie Fantasy") },
         { kEdsAEMode_Movie_Old, _T("Movie Old") },
         { kEdsAEMode_Movie_Memory, _T("Movie Memory") },
         { kEdsAEMode_Movie_DirectMono, _T("Movie Direct mono") },
         { kEdsAEMode_Movie_Mini, _T("Movie mini") },
         { kEdsAEMode_PanningAssist, _T("Panning assist") },
         { kEdsAEMode_GroupPhoto, _T("Group photo") },
         { kEdsAEMode_Unknown, _T("Unknown") },
         { 0, nullptr }
      }
   },
