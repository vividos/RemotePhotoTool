...
/// view for HDR panorama photo mode
class HDRPanoramaPhotoModeView :
   public CDialogImpl<HDRPanoramaPhotoModeView>,
   public CDialogResize<HDRPanoramaPhotoModeView>,
   public CWinDataExchange<HDRPanoramaPhotoModeView>,
   public IPhotoModeView
{
public:
   /// ctor
   HDRPanoramaPhotoModeView(IPhotoModeViewHost& host) throw();
   /// dtor
   virtual ~HDRPanoramaPhotoModeView() throw() {}

   enum { IDD = IDD_PHOTOMODE_HDR_PANORAMA_FORM };
...
private:
   ...
   {
      return CDialogImpl<HDRPanoramaPhotoModeView>::Create(hWndParent);
   }
...
private:
   // ddx map
   BEGIN_DDX_MAP(HDRPanoramaPhotoModeView)
   ...
   // message map
   BEGIN_MSG_MAP(HDRPanoramaPhotoModeView)
