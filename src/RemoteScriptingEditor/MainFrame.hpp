...
private:
   ...
   BEGIN_UPDATE_UI_MAP(MainFrame)
      UPDATE_ELEMENT(ID_FILE_NEW, UPDUI_MENUPOPUP | UPDUI_TOOLBAR | UPDUI_RIBBON)
      UPDATE_ELEMENT(ID_FILE_OPEN, UPDUI_MENUPOPUP | UPDUI_TOOLBAR | UPDUI_RIBBON)
      UPDATE_ELEMENT(ID_FILE_SAVE, UPDUI_MENUPOPUP | UPDUI_TOOLBAR | UPDUI_RIBBON)
      UPDATE_ELEMENT(ID_FILE_SAVE_AS, UPDUI_MENUPOPUP | UPDUI_TOOLBAR | UPDUI_RIBBON)
      UPDATE_ELEMENT(ID_EDIT_UNDO, UPDUI_MENUPOPUP | UPDUI_TOOLBAR | UPDUI_RIBBON)
      UPDATE_ELEMENT(ID_EDIT_CUT, UPDUI_MENUPOPUP | UPDUI_TOOLBAR | UPDUI_RIBBON)
      UPDATE_ELEMENT(ID_EDIT_COPY, UPDUI_MENUPOPUP | UPDUI_TOOLBAR | UPDUI_RIBBON)
      UPDATE_ELEMENT(ID_EDIT_PASTE, UPDUI_MENUPOPUP | UPDUI_TOOLBAR | UPDUI_RIBBON)
      UPDATE_ELEMENT(ID_EDIT_CLEAR, UPDUI_MENUPOPUP | UPDUI_TOOLBAR | UPDUI_RIBBON)
      UPDATE_ELEMENT(ID_EDIT_SELECT_ALL, UPDUI_MENUPOPUP | UPDUI_TOOLBAR | UPDUI_RIBBON)
      UPDATE_ELEMENT(ID_EDIT_FIND, UPDUI_MENUPOPUP | UPDUI_TOOLBAR | UPDUI_RIBBON)
      UPDATE_ELEMENT(ID_EDIT_REPEAT, UPDUI_MENUPOPUP | UPDUI_TOOLBAR | UPDUI_RIBBON)
      UPDATE_ELEMENT(ID_EDIT_REPLACE, UPDUI_MENUPOPUP | UPDUI_TOOLBAR | UPDUI_RIBBON)
      UPDATE_ELEMENT(ID_VIEW_RIBBON, UPDUI_MENUPOPUP | UPDUI_TOOLBAR | UPDUI_RIBBON)
      UPDATE_ELEMENT(ID_SCRIPT_RUN, UPDUI_MENUPOPUP | UPDUI_TOOLBAR | UPDUI_RIBBON)
      UPDATE_ELEMENT(ID_SCRIPT_STOP, UPDUI_MENUPOPUP | UPDUI_TOOLBAR | UPDUI_RIBBON)
   END_UPDATE_UI_MAP()
